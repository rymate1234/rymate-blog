...
(function () {
    ...
    Renderer.prototype.taskitem = function (text, checked, disabled, i) {
        return '<li class="task-list-item"><label>' + '<input type="checkbox"' + ' class="task-list-item-checkbox"' + ' data-item-index="' + i + '"' + ' data-item-complete="' + (checked ? 1 : 0) + '"' + (disabled ? ' disabled=""' : '') + '>' + ' ' + text + '</label></li>';
    };
